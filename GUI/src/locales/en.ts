export const en = {
  ...
  semanticSearchMode: 'Semantic search',
  semanticSearchPlaceholder: 'Describe the image, e.g. “arrow icon”...',
  semanticSearch: 'Search',
  semanticSearching: 'Searching',
  buildImageIndex: 'Build index',
  semanticPreparing: 'Preparing semantic search...',
  modelDownloadProgress: (file: string, percent: number) => `Downloading model ${file} ${percent}%`,
  indexProgress: (processed: number, total: number) => `Building index ${processed}/${total}`,
  indexBuilt: (count: number) => `Index updated with ${count} image(s)`,
  cancelSearch: 'Cancel',
  ...
  semanticResultCount: (n: number) => `${n} matching image(s)`,
  semanticIdle: 'Enter a description to search; without one, images use the default order',
  noSemanticResults: 'No matching images',
  tryAnotherDescription: 'Try a more specific description',
